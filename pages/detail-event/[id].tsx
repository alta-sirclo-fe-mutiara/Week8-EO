          ...
          <div className="row d-flex flex-column-reverse flex-md-row my-1">
            <div className="col-md-8 my-3">
              ...
              <p className={styles.palagraf}>
                ...
                veniam obcaecati incidunt laudantium ea vero maxime? Eligendi ab
                illo, consectetur corporis fugit libero sint doloremque!
                Voluptate sequi dolor soluta amet?
              </p>
            </div>
